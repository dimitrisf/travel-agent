...
const CITIES: {
  ...
  { name: 'Athens', countryIso: 'GR', weather: { tempC: 32, conditions: 'sunny' } },
  { name: 'Berlin', countryIso: 'DE', weather: { tempC: 24, conditions: 'clear' } },
  { name: 'London', countryIso: 'GB', weather: { tempC: 18, conditions: 'overcast with light rain' } },
  { name: 'Tokyo', countryIso: 'JP', weather: { tempC: 26, conditions: 'humid, partly cloudy' } },
  { name: 'New York', countryIso: 'US', weather: { tempC: 21, conditions: 'clear' } },
];

const AIRPORTS = [
  { iata: 'ATH', icao: 'LGAV', name: 'Athens International Airport', city: 'Athens', lat: 37.9364, lon: 23.9445, tz: 'Europe/Athens' },
  { iata: 'BER', icao: 'EDDB', name: 'Berlin Brandenburg', city: 'Berlin', lat: 52.3667, lon: 13.5033, tz: 'Europe/Berlin' },
  { iata: 'LHR', icao: 'EGLL', name: 'London Heathrow', city: 'London', lat: 51.47, lon: -0.4543, tz: 'Europe/London' },
  { iata: 'HND', icao: 'RJTT', name: 'Tokyo Haneda', city: 'Tokyo', lat: 35.5494, lon: 139.7798, tz: 'Asia/Tokyo' },
  { iata: 'JFK', icao: 'KJFK', name: 'John F. Kennedy International', city: 'New York', lat: 40.6413, lon: -73.7781, tz: 'America/New_York' },
] as const;
...
const FLIGHT_DEFS: {
  ...
  { airline: 'A3', number: '824', from: 'ATH', to: 'BER', baseEUR: 138, durationMin: 100, stops: 0, departureLocal: '09:40' },
  { airline: 'A3', number: '825', from: 'BER', to: 'ATH', baseEUR: 145, durationMin: 110, stops: 0, departureLocal: '12:30' },
  { airline: 'LH', number: '1753', from: 'ATH', to: 'BER', baseEUR: 149, durationMin: 160, stops: 1, departureLocal: '12:30' },
  { airline: 'LH', number: '1754', from: 'BER', to: 'ATH', baseEUR: 155, durationMin: 160, stops: 1, departureLocal: '15:00' },
  { airline: 'A3', number: '600', from: 'ATH', to: 'LHR', baseEUR: 220, durationMin: 240, stops: 0, departureLocal: '07:30' },
  { airline: 'BA', number: '632', from: 'LHR', to: 'ATH', baseEUR: 215, durationMin: 250, stops: 0, departureLocal: '14:00' },
  { airline: 'LH', number: '432', from: 'BER', to: 'LHR', baseEUR: 120, durationMin: 110, stops: 0, departureLocal: '08:15' },
  { airline: 'BA', number: '990', from: 'LHR', to: 'BER', baseEUR: 115, durationMin: 105, stops: 0, departureLocal: '17:45' },
  { airline: 'BA', number: '178', from: 'LHR', to: 'JFK', baseEUR: 510, durationMin: 470, stops: 0, departureLocal: '11:00' },
  { airline: 'AA', number: '100', from: 'JFK', to: 'LHR', baseEUR: 480, durationMin: 420, stops: 0, departureLocal: '21:30' },
  { airline: 'JL', number: '32', from: 'HND', to: 'LHR', baseEUR: 850, durationMin: 730, stops: 0, departureLocal: '10:00' },
  { airline: 'JL', number: '33', from: 'LHR', to: 'HND', baseEUR: 830, durationMin: 720, stops: 0, departureLocal: '19:00' },
];
...
const HOTELS: HotelSeed[] = [
  {
    name: 'Hotel Berlin Central', city: 'Berlin',
    address: 'Friedrichstr. 100, 10117 Berlin',
    stars: 4, rating: 8.7, lat: 52.5176, lon: 13.3884,
    amenities: ['Breakfast', 'Free WiFi', 'Gym', 'Air Conditioning'],
    cancellation: { free: true, description: 'Free cancellation up to 24 hours before check-in.' },
    rooms: [
  ...
  {
    name: 'City Budget Inn', city: 'Berlin',
    address: 'Skalitzer Str. 80, 10997 Berlin',
    stars: 3, rating: 8.2, lat: 52.4998, lon: 13.4419,
    amenities: ['Free WiFi', 'Pet Friendly'],
    cancellation: { free: true, description: 'Free cancellation up to 7 days before check-in.' },
    rooms: [
  ...
  {
    name: 'Grand Berlin Plaza', city: 'Berlin',
    address: 'Kurfürstendamm 12, 10719 Berlin',
    stars: 5, rating: 9.1, lat: 52.5037, lon: 13.3279,
    amenities: ['Breakfast', 'Free WiFi', 'Swimming Pool', 'Pet Friendly', 'Parking', 'Gym', 'Air Conditioning', 'Spa'],
  ...
  {
    name: 'Athens Acropolis Suites', city: 'Athens',
    address: 'Dionysiou Areopagitou 25, 11742 Athens',
    stars: 4, rating: 8.6, lat: 37.9691, lon: 23.7286,
  ...
  {
    name: 'Plaka Boutique', city: 'Athens',
    address: 'Adrianou 80, 10556 Athens',
    stars: 3, rating: 8.5, lat: 37.9740, lon: 23.7300,
    amenities: ['Breakfast', 'Free WiFi', 'Pet Friendly'],
    cancellation: { free: true, description: 'Free cancellation up to 24 hours before check-in.' },
    rooms: [
      { name: 'Standard', maxGuests: 2, beds: 1, basePrice: 95 },
    ],
  },
  {
    name: 'Athenaeum Grand', city: 'Athens',
    address: 'Vasilissis Sofias 46, 11528 Athens',
    stars: 5, rating: 9.0, lat: 37.9756, lon: 23.7468,
    amenities: ['Breakfast', 'Free WiFi', 'Swimming Pool', 'Parking', 'Gym', 'Air Conditioning', 'Spa'],
    cancellation: { free: true, description: 'Free cancellation up to 48 hours before check-in.' },
    rooms: [
  ...
  {
    name: 'Westminster Garden Hotel', city: 'London',
    address: '34 Buckingham Gate, London SW1E 6PA',
    stars: 4, rating: 8.4, lat: 51.4994, lon: -0.1357,
    amenities: ['Breakfast', 'Free WiFi', 'Gym', 'Air Conditioning'],
    cancellation: { free: true, description: 'Free cancellation up to 24 hours before check-in.' },
    rooms: [
  ...
  {
    name: 'Kings Cross Budget', city: 'London',
    address: '12 Pentonville Rd, London N1 9HF',
    stars: 2, rating: 7.8, lat: 51.5320, lon: -0.1230,
    amenities: ['Free WiFi'],
    cancellation: { free: true, description: 'Free cancellation up to 48 hours before check-in.' },
    rooms: [
      { name: 'Standard', maxGuests: 2, beds: 1, basePrice: 75 },
    ],
  },
  {
    name: 'The Strand Royale', city: 'London',
    address: '1 Savoy Pl, London WC2R 0BP',
    stars: 5, rating: 9.2, lat: 51.5101, lon: -0.1196,
    amenities: ['Breakfast', 'Free WiFi', 'Swimming Pool', 'Pet Friendly', 'Parking', 'Gym', 'Air Conditioning', 'Spa'],
    cancellation: { free: false, description: 'Non-refundable.' },
    rooms: [
  ...
  {
    name: 'Shibuya Modern', city: 'Tokyo',
    address: '2-21-1 Dogenzaka, Shibuya, Tokyo 150-0043',
    stars: 4, rating: 8.8, lat: 35.6580, lon: 139.6994,
    amenities: ['Breakfast', 'Free WiFi', 'Gym', 'Air Conditioning'],
    cancellation: { free: true, description: 'Free cancellation up to 24 hours before check-in.' },
    rooms: [
  ...
  {
    name: 'Asakusa Ryokan', city: 'Tokyo',
    address: '1-2-15 Asakusa, Taito, Tokyo 111-0032',
    stars: 3, rating: 9.0, lat: 35.7148, lon: 139.7967,
    amenities: ['Breakfast', 'Free WiFi', 'Swimming Pool'],
    cancellation: { free: false, description: 'Non-refundable.' },
    rooms: [
      { name: 'Tatami', maxGuests: 2, beds: 1, basePrice: 110 },
    ],
  },
  {
    name: 'Midtown Manhattan Suites', city: 'New York',
    address: '152 W 49th St, New York, NY 10019',
    stars: 4, rating: 8.5, lat: 40.7600, lon: -73.9830,
    amenities: ['Breakfast', 'Free WiFi', 'Pet Friendly', 'Gym', 'Air Conditioning'],
    cancellation: { free: true, description: 'Free cancellation up to 24 hours before check-in.' },
    rooms: [
  ...
  {
    name: 'Brooklyn Bay Inn', city: 'New York',
    address: '88 Bay St, Brooklyn, NY 11231',
    stars: 3, rating: 8.1, lat: 40.6800, lon: -74.0070,
    amenities: ['Free WiFi', 'Pet Friendly', 'Parking'],
    cancellation: { free: true, description: 'Free cancellation up to 7 days before check-in.' },
    rooms: [
      { name: 'Standard', maxGuests: 2, beds: 1, basePrice: 130 },
    ],
  },
  {
    name: 'The Empire Penthouse', city: 'New York',
    address: '350 5th Ave, New York, NY 10118',
    stars: 5, rating: 9.3, lat: 40.7484, lon: -73.9857,
    amenities: ['Breakfast', 'Free WiFi', 'Swimming Pool', 'Parking', 'Gym', 'Air Conditioning', 'Spa'],
    cancellation: { free: false, description: 'Non-refundable.' },
    rooms: [
...
async function main() {
  ...
  for (const a of AIRPORTS) {
    ...
    if (!cityId) throw new Error(`Airport "${a.iata}" references unknown city "${a.city}"`);
  ...
  for (const f of FLIGHT_DEFS) {
    ...
    const [hh, mm] = f.departureLocal.split(':').map(Number) as [number, number];
  ...
  for (const h of HOTELS) {
    ...
    for (const name of h.amenities) {
      ...
      if (!amenityId)
        throw new Error(`Hotel "${h.name}" references unknown amenity "${name}"`);
